...
JsonRoutes.add("get", "/fhir/DiagnosticReport", function (req, res, next) {
  ...
  if (accessToken || process.env.NOAUTH) {
    ...
    process.env.DEBUG && console.log('DiagnosticReports.find(id).count()', DiagnosticReports.find(databaseQuery).count());
    ...
    diagnosticReportData.forEach(function(diagnosticReport){
